...
class ShowList(object):
	...
	def appendData(self):
		print("追加数据")
		print("L1列表尾追加一个列表[1,2,3]，执行命令L1.append([1,2,3]")
		self.L1.append([1,2,3])
		print(("L1 = "), end=' ')
		print((self.L1))
		print("L2列表尾追加一个元组('a','b','c')，执行命令L1.append(('a','b','c')")
	...
	def deleteData(self):
		...
		print(("L1 = "), end=' ')
		print((self.L1))
		print("删除L1的第1个元素，执行命令L1.pop(0)")
		self.L1.pop(0)
		print(("L1 = "), end=' ')
		print((self.L1))
		print("删除L2的第4个元素，执行命令L1.pop(3)")
		self.L2.pop(3)
		print(("L2 = "), end=' ')
		print((self.L2))
		print('\n')
	...
	def subList(self):
		print("列表分片")
		print("取列表L1的第3到最后一个元素组成的新列表，执行命令L1[2:]")
		print((self.L1[2:]))
		print("取列表L2的第2个到倒数第2个元素组成的新列表，步长为2，执行命令L2[1:-1:2]")
		print((self.L2[1:-1:2]))
		print('\n')
