...
class QiushispiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
        subSelector = response.xpath('//div[@class="article block untagged mb15 typs_long" and @id]|//div[@class="article block untagged mb15 typs_hot" and @id]|//div[@class="article block untagged mb15 typs_old" and @id]')
        items = []
